...
public class AdopetConsoleApplication {
    ...
    private static void importarPetsAbrigo() throws IOException, InterruptedException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            HttpResponse<String> response = dispararRequisicaoPost(uri, json, client);
    ...
    private static void listarPetsAbrigos() throws IOException, InterruptedException {
        System.out.println("Digite o id ou nome do abrigo:");
        String idOuNome = new Scanner(System.in).nextLine();
    ...
    private static HttpResponse<String> dispararRequisicaoGet(final String uri, final HttpClient client) throws IOException, InterruptedException {
    ...
    private static HttpResponse<String> dispararRequisicaoPost(final String uri, final JsonObject json, final HttpClient client) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(uri))
